...
def load_csv_to_table():
    df = pd.read_csv("src/app/data/institution_kpi_table.csv")
    print("CSV 읽기 성공")
...
def load_csv_to_table_alio():
    df = pd.read_csv("src/app/data/alio_master_table.csv")
    print("CSV 읽기 성공")
    # (주) 앞에 붙이기
...
def load_csv_to_table_flexible():
    df = pd.read_csv("src/app/data/institution_flexible_work_table.csv")
    print("CSV 읽기 성공")
...
def load_csv_to_table_risk():
    df = pd.read_csv("src/app/data/institution_quarter_kpi_table.csv")
    print("CSV 읽기 성공")
